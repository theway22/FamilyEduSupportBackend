...
public class UsersController  {
	...
	@ResponseBody
	@PostMapping("/admin/users/myfans")
	public JsonResult myfans(){

		String userid=request.getParameter("userid");
		if(userid==null)
			return JsonResult.error(-1,"参数异常");
		List<Huiyuan> listHuiyuan=usersService.getFans(new Integer(userid));
	...
	public JsonResult list(){
		...
		return JsonResult.success(1, "获取成功", usersService.getEntityPlus(map));
	...
	@PostMapping({"/admin/users/load","/admin/users/info"})
